...
namespace SRP_2207
{
    internal class Patient_Examination_SRP_2207
    {
        ...
        public Patient_Examination_SRP_2207(Patient_SRP_2207 patient, Doctor_SRP_2207 doctor, DateTime examinationDate, string findings, string diagnoses)
        {
        ...
        public void DisplayPatientExaminationInfo()
        {
            Console.WriteLine();
        ...
        public static void CancelExamination(List<Patient_Examination_SRP_2207> examinations, Patient_SRP_2207 patient)
        {
            Patient_Examination_SRP_2207 examinationToCancel = examinations.Find(e => e.Patient_2207 == patient);
        ...
        public static void ReferPatient(List<Patient_Examination_SRP_2207> examinations, Patient_SRP_2207 patient, Doctor_SRP_2207 newDoctor)
        {
            Patient_Examination_SRP_2207 examinationToRefer = examinations.Find(e => e.Patient_2207 == patient);
